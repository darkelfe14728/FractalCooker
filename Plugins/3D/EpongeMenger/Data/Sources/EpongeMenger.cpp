...
void EpongeMenger::generer () {
	...
	{	// Initialisation du 1er cube
		cubeInitial.avant.haut.gauche.x = -1;
		cubeInitial.avant.haut.gauche.y = 1;
		cubeInitial.avant.haut.gauche.z = 1;

		cubeInitial.avant.haut.droite.x = 1;
		cubeInitial.avant.haut.droite.y = 1;
		cubeInitial.avant.haut.droite.z = 1;

		cubeInitial.avant.bas.droite.x = 1;
		cubeInitial.avant.bas.droite.y = -1;
		cubeInitial.avant.bas.droite.z = 1;

		cubeInitial.avant.bas.gauche.x = -1;
		cubeInitial.avant.bas.gauche.y = -1;
		cubeInitial.avant.bas.gauche.z = 1;

		cubeInitial.arriere.haut.gauche.x = -1;
		cubeInitial.arriere.haut.gauche.y = 1;
		cubeInitial.arriere.haut.gauche.z = -1;

		cubeInitial.arriere.haut.droite.x = 1;
		cubeInitial.arriere.haut.droite.y = 1;
		cubeInitial.arriere.haut.droite.z = -1;

		cubeInitial.arriere.bas.droite.x = 1;
		cubeInitial.arriere.bas.droite.y = -1;
		cubeInitial.arriere.bas.droite.z = -1;

		cubeInitial.arriere.bas.gauche.x = -1;
		cubeInitial.arriere.bas.gauche.y = -1;
		cubeInitial.arriere.bas.gauche.z = -1;
	}
...
#define NEXT_STEP() \
	emit progression(++m_current); \
	if(isCancel()) \
		return;

void EpongeMenger::diviser (const Cube & original, CubeList & final) {
